...
class ProductsList(ListView):
    ...
    context_object_name = 'production'  # это имя списска, в котором будут лежать все объекты, его надо указать, чтобв обратиться к самому списку объектов через HTML-шаблон
